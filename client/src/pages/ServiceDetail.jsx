              ...
              <div style={{ background: 'var(--bg)', borderRadius: 12, padding: 18, marginBottom: 18 }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10, marginBottom: 10 }}>
                  <input value={reviewForm.nickname} onChange={e => setReviewForm({ ...reviewForm, nickname: e.target.value })}
                    ...
                    style={{ border: '1.5px solid var(--border)', borderRadius: 10, padding: '10px 14px', fontSize: 14, background: '#fff', color: 'var(--text)', outline: 'none', fontFamily: 'inherit' }}
                  />
                  ...
                  <>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 5 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <button onClick={() => { setEditingReview(r.id); setEditForm({ nickname: '', rating: r.rating, comment: r.comment || '' }); }}
