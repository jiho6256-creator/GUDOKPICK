...
const LOGO_IMAGES = {
  ...
  disneyplus:  'https://res.cloudinary.com/dazyzaeda/image/upload/v1781448039/gudokpick_disneyplus.png',
  ...
  baemin:      'https://res.cloudinary.com/dazyzaeda/image/upload/v1781448037/gudokpick_baemin.png',
  yogiyo:      gf('yogiyo.co.kr'),
  coupangeats: gf('eats.coupang.com'),
  xbox:        'https://res.cloudinary.com/dazyzaeda/image/upload/v1781448040/gudokpick_xbox.png',
